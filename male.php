...
<html lang="en">
  ...
  <head>
    ...
    <title>Casting Lens - Male Models</title>
...
if(is_dir($imagesDirectory))
{
    ...
    while (($image = readdir($opendirectory)) !== false)
	{
		...
		if(($imgFileType == 'jpg') || ($imgFileType == 'png'))
		{
			...
			echo "<a href='single.php?img=$image&gen=male'><img src='image/male/".$image."' class='zoom'></a> ";
                        $exp = explode(".",$image);
                        $imgname=$exp[0];
                        echo "<div class='down-content'>
                          <a href='single.php?img=$image&gen=male'><h4>".$imgname."</h4></a> 
                        </div></div>
                    </div>";
